...
export const localizedData = {
  ...
  home: {
    text1: { ms: "Semuanya", en: "Everything" },
    text2: { ms: "Akan Musnah Apabila", en: "Gets Destroyed When" },
    text3: { ms: "Anai-Anai", en: "Termites" },
    text4: { ms: "Menyerang!", en: "Attack!" },
  },
  productListing: {
    buttonText: { ms: "BELI SEKARANG", en: "SHOP NOW" },
  },
  hero: {
    ...
    text1: { ms: "UNIT TERJUAL", en: "UNITS SOLD" },
    text2: { ms: "PELANGGAN BERPUAS HATI", en: "SATISFIED CUSTOMERS" },
  },
  faq: {
    text1: { ms: "Soalan Lazim", en: "Frequently Asked" },
    text2: { ms: "Yang Ditanya", en: "Questions" },
  },
  gift: {
    heading1: { ms: "PERCUMA", en: "FREE" },
